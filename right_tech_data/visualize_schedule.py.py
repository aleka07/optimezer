...
# OUTPUT_IMAGE_FILE = 'gantt_chart.png'
...
OUTPUT_IMAGE_FILE = 'fifo_summary_correct.png'
...
def create_gantt_chart(csv_path, output_path):
    ...
    fig, ax = plt.subplots(figsize=(20, max(10, len(unique_batches) * 0.4)))
    ...
    plt.tight_layout(rect=[0, 0, 0.9, 1]) # Оставляем место справа для легенды
