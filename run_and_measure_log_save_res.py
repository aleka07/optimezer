...
BASE_DIR = 'jan'
DATES = ['3', '4', '6', '7', '8', '10']
RESULTS_FILENAME = 'execution_times.csv'
...
# IMPORTANT: Remember to delete the old 'execution_times.csv' file first!
if os.path.exists(RESULTS_FILENAME):
    print(f"--- Found results file '{RESULTS_FILENAME}'. Loading data... ---")
    print("--- To re-run the benchmarks with new settings, please delete this file. ---")
    ...
    for date in DATES:
        ...
        for alg_name in ALGORITHM_ORDER:
            ...
            # --- ВОТ ЭТА СТРОКА ФОРМАТИРУЕТ ДАТЫ ПРАВИЛЬНО ---
            execution_results.append({
                'Date': f'Jan {date}',  # Creates labels like 'Jan 3', 'Jan 4'
                'Algorithm': alg_name, 
