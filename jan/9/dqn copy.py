...
if __name__ == "__main__":
    ...
    orders = {
        "Формовой": 2151,          # Формовой хлеб 600гр (1924) + упаковка (227)
        "Мини формовой": 279,       # Формовой мини хлеб 300гр (188) + упаковка (91)
        "Бородинский": 473,         # Бородинский хлеб 300гр (328) + упаковка (145)
        "Домашний": 8,              # Домашний хлеб 600гр в упаковке
        "Багет луковый": 37,        # Багет Луковый 300гр в упаковке
        "Багет новый": 226,         # Багет Новый 300гр в упаковке
        "Багет отрубной": 32,       # Багет Отрубной 300гр в упаковке
        "Премиум": 0,               # Багет Премиум (нет продаж 9 января)
        "Батон Верный": 40,         # Батон Верный 400гр в упаковке
        "Батон Нарезной": 280,      # Батон Нарезной 400гр (204) + упаковка (76)
        "Береке": 122,              # Береке хлеб (77) + упаковка (45)
        "Жайлы": 112,               # Жайлы хлеб (75) + упаковка (37)
        "Диета": 240,               # Диетический хлеб (180) + упаковка (60)
        "Здоровье": 22,             # Здоровье хлеб (9) + упаковка (13)
        "Любимый": 652,             # Любимый хлеб (576) + упаковка (76)
        "Немецкий хлеб": 10,        # Немецкий хлеб 250гр в упаковке
        "Отрубной (общий)": 191,    # Отрубной хлеб (107) + упаковка (84)
        "Плетенка": 89,             # Плетенка (45+15+16+13)
        "Семейный": 265,            # Семейный хлеб (174) + упаковка (91)
        "Славянский": 6,            # Славянский хлеб 600гр в упаковке
        "Зерновой Столичный": 12,   # Столичный хлеб 450гр в упаковке
        "Сэндвич": 2714,            # Все виды сэндвичей (39+65+70+57+2478+1+1+3)
        "Хлеб «Тартин бездрожжевой»": 12,  # Тартин
        "Хлеб «Зерновой»": 128,     # Хлеб Зерновой (115) + упаковка (13)
        "Чиабатта": 18,             # Хлеб Чиабатта шт
        "Булочка для гамбургера большой с кунжутом": 2310,
        "Булочка для хотдога штучно": 811,
        "Датский": 30,              # Датский хлеб (5) + упаковка (25)
