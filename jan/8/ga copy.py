...
orders = {
    "Формовой": 2503,          # Формовой хлеб 600гр (2292) + упаковка (211)
    "Мини формовой": 354,       # Формовой мини хлеб 300гр (289) + упаковка (65)
    "Бородинский": 631,         # Бородинский хлеб 300гр (456) + упаковка (175)
    "Домашний": 12,             # Домашний хлеб 600гр в упаковке (кредит 12)
    "Багет луковый": 52,        # Багет Луковый 300гр в упаковке
    "Багет новый": 274,         # Багет Новый 300гр в упаковке
    "Багет отрубной": 48,       # Багет Отрубной 300гр в упаковке
    "Премиум": 13,              # Багет Премиум 350гр в упаковке (кредит 13)
    "Батон Верный": 50,         # Батон Верный 400гр в упаковке
    "Батон Нарезной": 387,      # Батон Нарезной 400гр (310) + упаковка (77)
    "Береке": 152,              # Береке хлеб 420гр (92) + упаковка (60)
    "Жайлы": 183,               # Жайлы хлеб 600гр (140) + упаковка (43)
    "Диета": 360,               # Диетический хлеб (242) + упаковка (118)
    "Здоровье": 22,             # Здоровье хлеб (8) + упаковка (14)
    "Любимый": 862,             # Любимый хлеб 500гр (789) + упаковка (73)
    "Немецкий хлеб": 11,        # Немецкий хлеб 250гр в упаковке
    "Отрубной (общий)": 260,    # Отрубной хлеб (160) + упаковка (100)
    "Плетенка": 112,            # Плетенка (61+16+16+19)
    "Семейный": 359,            # Семейный хлеб (234) + упаковка (125)
    "Славянский": 6,            # Славянский хлеб 600гр в упаковке
    "Зерновой Столичный": 19,   # Столичный хлеб 450гр в упаковке
    "Сэндвич": 3830,            # Все виды сэндвичей (92+39+1500+35+2131+19+2+2)
    "Хлеб «Тартин бездрожжевой»": 17,  # Тартин бездрожжевой
    "Хлеб «Зерновой»": 144,     # Хлеб Зерновой (131) + упаковка (13)
    "Чиабатта": 16,             # Хлеб Чиабатта шт
    "Булочка для гамбургера большой с кунжутом": 670, 
    "Булочка для хотдога штучно": 705,
    "Датский": 29,              # Датский хлеб (5) + упаковка (24)
    "Баварский Деревенский Ржаной": 13  # Деревенский хлеб (10) + упаковка (3)
}
