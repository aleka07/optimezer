...
orders = {
    # Этот словарь сгенерирован из большого JSON-запроса для тестирования.
    # Названия приведены к чистому виду (без кавычек и лишних пробелов),
    # как они обрабатываются на сервере.

    "Хлеб Формовой": 500,
    "Хлеб Семейный": 120,
    "Тостовый хлеб нарезанный": 250,
    "Сэндвич Панини / Сэндвич Панини с кунжутом": 80,
    "Багет Премиум": 55,
    "Булочка для хот-дог/гамбургера (World class)": 300,
    "Хлеб Бородинский": 410,
    "Плетенка с посыпкой (мак/кунжут)": 95,
    "Батон Нарезной": 600,
    "Хлеб Ржаной": 150,
    "Хлеб Диетический": 75,
    "Панировочные сухари": 40,
    "Хлеб Солодовый с семечками": 110,
    "Лепешка с сыром и луком": 130,
    "Багет с луком": 60,
    "Хлеб Мини Формовой": 220,
    "Хлеб Любимый, Детский": 180,
    "Кукурузный хлеб": 85,
    "Хлеб Спорт Актив": 105,
    "Чиабатта": 90,
}
...
OUTPUT_CSV_FILE = os.path.join(script_dir, '1production_schedule_v2.csv')
OUTPUT_TXT_FILE = os.path.join(script_dir, '1production_summary_v2.txt')
