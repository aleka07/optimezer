...
orders = {
    "Формовой": 1950,             # Формовой хлеб 600гр (2270) + упаковка (177)
    "Мини формовой": 387,          # Формовой мини хлеб 300гр (298) + упаковка (89)
    "Бородинский": 495,            # Бородинский хлеб 300гр (427) + упаковка (168)
    ...
    "Батон Нарезной": 300,         # Батон Нарезной 400гр (317) + упаковка (84)
    ...
    "Семейный": 290,               # Семейный хлеб 600гр (282) + упаковка (108)
    ...
    "Булочка для гамбургера большой с кунжутом": 1120,  # Булочка для гамбургера
    "Булочка для хотдога штучно": 485,  # Булочка для хотдога  
