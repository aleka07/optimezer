...
tech_map_data = {
    ...
    "Булочка для гамбургера большой с кунжутом": 
                            {"Комбинирование": "0:21:00", "Смешивание": "0:10:30", "Формовка": "0:11:00", "Расстойка": "0:25:00", "Выпекание": "0:22:00", "Остывание": "0:45:00", "Упаковка": "0:15:00"},
    ...
    "Хлеб «Тартин бездрожжевой»":
                            {"Комбинирование": "0:21:00", "Смешивание": "0:10:30", "Формовка": "0:11:00", "Расстойка": "0:20:00", "Выпекание": "0:16:30", "Остывание": "1:00:00", "Упаковка": "0:10:00"},
    ...
    "Баварский Деревенский Ржаной":
                            {"Комбинирование": "0:21:00", "Смешивание": "0:10:30", "Формовка": "0:11:00", "Расстойка": "0:30:00", "Выпекание": "0:18:30", "Остывание": "1:30:00", "Упаковка": "0:10:00"},
...
orders = {
    # Группа "Формовые хлеба"
    "Формовой": 2185,       # Формовой хлеб 600гр
    "Мини формовой": 378,   # Формовой мини хлеб 300гр (274) + упаковка (104) 
    
    # Группа "Бородинский"
    "Бородинский": 548,     # Бородинский хлеб 300гр (401) + упаковка (147)
    
    # Группа "Домашний"
    "Домашний": 10,         # Домашний хлеб 600гр в упаковке (10)
    
    # Группа "Багеты"
    "Багет луковый": 57,    # Багет Луковый 300гр в упаковке (57)
    "Багет новый": 302,     # Багет Новый 300гр в упаковке (302)
    "Багет отрубной": 60,  # Багет Отрубной 300гр в упаковке
    "Премиум": 15,          # Багет Премиум 350гр в упаковке
    
    # Группа "Батоны"
    "Батон Верный": 48,     # Батон Верный 400гр в упаковке
    "Батон Нарезной": 335,  # Батон Нарезной 400гр (280) + упаковка (55)
    
    # Группа "Национальные хлеба"
    "Береке": 170,          # Береке хлеб 420гр (118) + упаковка (52)
    "Жайлы": 165,           # Жайлы хлеб 600гр (119) + упаковка (46)
    "Датский": 31,          # Датский хлеб 500гр (5) + упаковка (26)
    "Баварский Деревенский Ржаной": 10,  # Деревенский хлеб 500гр
    
    # Группа "Диетические"
    "Диета": 339,           # Диетический хлеб 200гр (241) + упаковка (98)
    "Здоровье": 17,         # Здоровье хлеб 400гр (5) + упаковка (12)
    
    # Группа "Специальные"
    "Семейный": 334,        # Семейный хлеб 600гр (235) + упаковка (99)
    "Славянский": 6,        # Славянский хлеб 600гр в упаковке
    "Немецкий хлеб": 7,     # Немецкий хлеб 250гр в упаковке
    "Зерновой Столичный": 13,  # Столичный хлеб 450гр в упаковке
    
    # Группа "Булочные изделия"
    "Булочка для гамбургера большой с кунжутом": 1530,
    "Булочка для хотдога штучно": 196,
    "Плетенка": 139,        # Плетенка с кунжутной посыпкой (85+20) + маковой (23+11)
    "Сэндвич": 1359,        # Сэндвич шт Панини (1324) + в упаковке (35)
    "Хлеб «Тартин бездрожжевой»": 14,  # Тартин бездрожжевой 430 гр в упаковке
    
    # Группа "Зерновые"
    "Хлеб «Зерновой»": 160, # Хлеб Зерновой 430гр (151) + упаковка (9)
    "Чиабатта": 16,         # Хлеб Чиабатта шт
}
...
machines_available = {
    ...
    "Выпекание": 6,
    "Остывание": 25,
    "Упаковка": 10, # Оставляем пока, чтобы код не ломался, но учтем ваше пожелание ниже
}
