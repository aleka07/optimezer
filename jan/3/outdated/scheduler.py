...
def run_scheduler():
    ...
    # Формируем полные пути к выходным файлам
    OUTPUT_CSV_FILE = os.path.join(current_dir, config.OUTPUT_CSV_FILE)
    OUTPUT_TXT_FILE = os.path.join(current_dir, config.OUTPUT_TXT_FILE)
