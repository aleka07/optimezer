...
if __name__ == "__main__":
    ...
    orders = {
        "Формовой": 2429,          # Формовой хлеб 600гр (2193) + упаковка (236)
        "Мини формовой": 348,       # Формовой мини хлеб 300гр (254) + упаковка (94)
        "Бородинский": 458,         # Бородинский хлеб 300гр (382) + упаковка (152)
        "Домашний": 10,             # Домашний хлеб 600гр в упаковке
        "Багет луковый": 45,        # Багет Луковый 300гр в упаковке
        "Багет новый": 252,         # Багет Новый 300гр в упаковке
        "Багет отрубной": 48,       # Багет Отрубной 300гр в упаковке
        "Премиум": 9,               # Багет Премиум 350гр в упаковке
        "Батон Верный": 59,         # Батон Верный 400гр в упаковке
        "Батон Нарезной": 363,      # Батон Нарезной 400гр (281) + упаковка (82)
        "Береке": 150,              # Береке хлеб (94) + упаковка (56)
        "Жайлы": 132,               # Жайлы хлеб (99) + упаковка (33)
        "Диета": 307,               # Диетический хлеб (227) + упаковка (80)
        "Здоровье": 19,             # Здоровье хлеб 400гр в упаковке
        "Любимый": 833,             # Любимый хлеб 500гр (747) + упаковка (86)
        "Немецкий хлеб": 10,        # Немецкий хлеб 250гр в упаковке
        "Отрубной (общий)": 245,    # Отрубной хлеб (162) + упаковка (83)
        "Плетенка": 125,            # Плетенка (65+22+20+18)
        "Семейный": 307,            # Семейный хлеб (216) + упаковка (91)
        "Славянский": 4,            # Славянский хлеб 600гр в упаковке
        "Зерновой Столичный": 18,   # Столичный хлеб 450гр в упаковке
        "Сэндвич": 3783,            # Все виды сэндвичей (79+41+50+45+969+10)
